...
*/
		...
		switch(alert("Temporary Ban?",,"Yes","No", "Cancel"))
			...
			if("No")
				...
				var/sticky = alert(usr,"Sticky Ban [M.ckey]? Нажатие кнопки Yes ломает систему банов. Нажимайте No, если не хотите понести суровое наказание.","Sticky Icky","Yes", "No") == "Yes"
				if(sticky)
