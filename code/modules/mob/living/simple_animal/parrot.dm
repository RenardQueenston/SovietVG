...
/mob/living/simple_animal/parrot/Poly
	...
	speak = list("Поли хочет крекер!", ":e Проверьте сингулярность, дурачье!",":e Настройте солнечные панели, лентяи!",":e КТО ВЗЯЛ ЧЁРТОВЫ РИГИ?!",":e ОХ ГОСПОДИ, ВЫ - ПОВОД ВЫЗВАТЬ ШАТТЛ")
