			...
			if (cl)
				...
				for (var/obj/item/weapon/mop/M in world)
					...
					if(ml)
						...
						ldat += "Mop - <b>\[[ml.x-WORLD_X_OFFSET[ml.z]],[ml.y-WORLD_Y_OFFSET[ml.z]] ([uppertext_alt(dir2text(direction))])\]</b> - [M.reagents.total_volume ? "Wet" : "Dry"]<br>"
				...
				for (var/obj/structure/mopbucket/B in world)
					...
					if(bl)
						...
						ldat += "Bucket - <b>\[[bl.x-WORLD_X_OFFSET[bl.z]],[bl.y-WORLD_Y_OFFSET[bl.z]] ([uppertext_alt(dir2text(direction))])\]</b> - Water level: [B.reagents.total_volume]/100<br>"
				...
				for (var/obj/machinery/bot/cleanbot/B in world)
					...
					if(bl)
						if (bl.z != cl.z)
							continue
						var/direction = get_dir(src, B)
						ldat += "Cleanbot - <b>\[[bl.x-WORLD_X_OFFSET[bl.z]],[bl.y-WORLD_Y_OFFSET[bl.z]] ([uppertext_alt(dir2text(direction))])\]</b> - [B.on ? "Online" : "Offline"]<br>"
